...
gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(".section-parallax .parallax-content").forEach(function (section, i) {
  var heightDiff = section.offsetHeight - section.parentElement.offsetHeight;
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(section, {
    y: -heightDiff
  }, {
    scrollTrigger: {
...
__webpack_require__(/*! ./panoramic */ "./source/_assets/js/panoramic.js");
...
function panoramic() {
  var dataDirection;
  gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.panoramic-block img').forEach(function (el, i) {
    dataDirection = el.closest('.panoramic-block').getAttribute('data-direction');
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(el, {
      scrollTrigger: {
        trigger: el,
        start: "top top",
        end: "bottom top",
