  ...
  <div id="smooth-content">
    <section id="hero">
      <div class="container">
        ...
        <img src="assets/images/hero-day-trees-hiker.svg" alt="Trees" class="hero-day-trees">
        <img src="assets/images/hero-night-trees-hiker.svg" alt="Trees" class="hero-night-trees">
    ...
    <section id="about">
      <div class="container about-container">
        <div class="row row-about">
          <div class="col-md-3">
            <img src="assets/images/tom-photo-bw.png" alt="Tom Farrell">
          </div>
          <div class="col-md-9">
            <h2 class="with-line mb-4">
              About Me
            </h2>
            <p>I'm a front-end developer with over 2 decades of experience developing custom websites and interactive animations. I can be described as analytical and detail-oriented with a creative eye and ability to build websites from concept to completion. I have years of experience working with cross functional teams and utilizing agile methodologies. I guess you can say, working with me is like night and day.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
      ...
      <div class="row row-portfolio">
        <div class="col-site col-md-6 col-lg-4">
          <a data-bs-toggle="modal" href="#graphiteBioModal" role="button">
        ...
        <div class="col-site col-md-6 col-lg-4">
          <a data-bs-toggle="modal" href="#arcellxModal" role="button">
            <img src="assets/images/site-itsjustlunch-2x.jpg" alt="It's Just Lunch website">
          </a>
        </div>
        <div class="col-site col-md-6 col-lg-4">
          <a data-bs-toggle="modal" href="#mmhModal" role="button">
            <img src="assets/images/site-itsjustlunch-2x.jpg" alt="It's Just Lunch website">
          </a>
        </div>
        <div class="col-site col-md-6 col-lg-4">
        ...
        <div class="col-site col-md-6 col-lg-4">
          <a data-bs-toggle="modal" href="#ultragenyxModal" role="button">
            <img src="assets/images/site-itsjustlunch-2x.jpg" alt="It's Just Lunch website">
          </a>
        </div>
      </div>

      <h2 class="with-line mb-5">CONCEPTS & PROTOTYPES</h2>
      <div class="row row-concepts">
        <div class="col-md-6 col-concept">
          <p class="codepen" data-height="300" data-default-tab="html,result" data-slug-hash="QeqKXe" data-user="tomfarrell" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
        ...
        <div class="col-md-6 col-concept">
          <p class="codepen" data-height="300" data-default-tab="html,result" data-slug-hash="QeMoZr" data-user="tomfarrell" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5 col-lg-3">
          <h2 class="with-line mb-5">Resume</h2>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-7 col-lg-8">
          ...
          <form id="contactForm">
              ...
              <div class="row mb-4">
                <div class="col">
                  <label for="firstName" class="form-label"><span class="visually-hidden">First</span> Name*</label>
                ...
                <div class="col">
                  <label for="lastName" class="form-label"><span class="visually-hidden">Last Name*</span>&nbsp;</label>
            ...
            <div class="mb-4">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-2">
                  <label for="phone2" class="form-label"><span class="visually-hidden">Phone Exchange Code</span>&nbsp;</label>
                  <input type="tel" class="form-control" id="phone2" maxlength="3">
                  <div id="phone2Help" class="form-text">###</div>
                </div>
                <div class="col-md-2">
                  <label for="phone3" class="form-label"><span class="visually-hidden">Phone Line Number</span>&nbsp;</label>
